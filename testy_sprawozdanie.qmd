...
```
Na powyższym wykresie widzimy, że testy oparte o przedział Wilsona i Cloppera-Pearsona także przybrały taki sam kształt jak test oparty o przedział Jeffreysa na poprzednim wykresie. Teraz moc wszystkich testów maleje od $1$ do $0$ i wszystkie zachowują przyjęty poziom istotności $\alpha = 0.05$. Krzywe pokrywają się w przybliżeniu do błędu symulacji Monte Carlo. Stąd, w tym przypadku nie istnieje test jednostajnie najmocniejszy, natomiast w przeciwieństwie do przypadku $n = 5$ tutaj każdy test zwróci zgodny z założeniami wynik.
